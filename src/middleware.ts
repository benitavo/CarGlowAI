...
export const config = {
  matcher: [
    ...
    '/((?!api|_next/static|_next/image|app|signin|signup|verify|forgot-password|reset-password|check-email|auth|onboarding|favicon\\.ico|.*\\.(?:png|jpg|jpeg|gif|svg|webp|ico|txt|xml|mp4|webm|mov|ogg)).*)',
  ],
}

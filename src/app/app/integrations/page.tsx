    ...
    <div className="pb-24 lg:pb-12">
      <section className="border-b border-white/[0.04] bg-gradient-to-b from-sage-500/[0.025] to-transparent">
        <div className="px-6 lg:px-10 py-8 max-w-[900px]">
          <div className="text-[11px] font-semibold tracking-[0.16em] uppercase text-sage-400/90 mb-2">Integrations</div>
      ...
      <div className="px-6 lg:px-10 py-8 max-w-[900px]">
          ...
          {integrations.map(int => (
            <div key={int.id}
              className={cn('rounded-2xl border p-5 flex items-center gap-4 transition-colors',
                connected[int.id] ? 'border-sage-500/25 bg-sage-500/[0.04]' : 'border-white/[0.06] bg-white/[0.015]'
              )}>
              ...
              <div className="flex-1 min-w-0">
                ...
                {connected[int.id] && int.lastSync && (
                  <div className="text-[11px] text-sage-400/80 mt-0.5">Synced {int.lastSync}</div>
                )}
              </div>
              <button
                ...
                className={cn('shrink-0 h-8 px-3 rounded-lg text-xs font-semibold transition-all',
                  connected[int.id]
                    ...
                    : 'bg-sage-500 hover:bg-sage-600 text-midnight shadow-sage-sm'
                )}>
        ...
        <div className="mt-8 rounded-2xl border border-white/[0.06] bg-white/[0.015] p-6">
          ...
          <div className="flex items-center gap-2 bg-midnight-900 rounded-lg px-4 py-3 font-mono text-xs text-offwhite/60 border border-white/[0.06]">
            <span className="text-sage-400">POST</span>
